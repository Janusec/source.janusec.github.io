...
> #`wget https://www.janusec.com/download/janusec-1.2.7-amd64.tar.gz`  
> #`tar zxf ./janusec-1.2.7-amd64.tar.gz`  
...
第一步：  
V0.9.9修改了配置文件格式，请备份config.json，并复制一份新的config.json，假设您下载的安装包在`/data/janusec-1.2.7-amd64.tar.gz`，升级步骤参考：  
